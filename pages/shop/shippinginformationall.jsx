...
const ShippingInformationAll = () => {
    ...
    const metodosPago = (dat) => {
        let ruta = "/shop/paymentmethodsall/";
        localStorage.setItem("numberprd", JSON.stringify("checkoutall"));
        router.push(ruta);
    };
                    ...
                    <div>
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} md={5} lg={5}>
                                <Grid container spacing={1}>
                                    <Grid item xs={12} md={12} lg={12}>
                                        <div className="cajaresumenenvioall">
                                            {prdComprarAhora.length > 0
                                                ? prdComprarAhora &&
                                                  prdComprarAhora.map(
                                                      (item, index) => {
                                                          return (
                                                              <div className="cajashippinginfall">
                                                                  <Grid
                                                                      container
                                                                      spacing={
                                                                          1
                                                                          ...
                                                                          <div>
                                                                              <Grid
                                                                                  ...
                                                                                  <Grid
                                                                                      ...
                                                                                      <div>
                                                                                          <img
                                                                                              className="imageshoppingcartcuatro"
                                                                                              src={
                                                                                                  URL_IMAGES_RESULTS +
                                                                                                  item.nombreimagen1
                                                                                              }
                                                                                  ...
                                                                                  <Grid
                                                                                      ...
                                                                                      <Grid
                                                                                          ...
                                                                                          <div className="textoproductocompracuatro">
                                                                                              {
                                                                                                  item.titulonombre
                                                                                              }
                                                                                          </div>
                                                                                      ...
                                                                                      <Grid
                                                                                          ...
                                                                                          <div className="ml-19 mt-8">
                                                                                              <Grid
                                                                                                  ...
                                                                                                  className="cajaundselectcompracuatro">
                                                                                                  <Grid
                                                                                                      item
                                                                                                      xs={
                                                                                                          12
                                                                                                  ...
                                                                                                  <Grid
                                                                                                      ...
                                                                                                      <input
                                                                                                          className="cajaundinputcompraall"
                                                                                                          type="text"
                                                                                                          defaultValue="1"
                                                                                                          value={
                                                                                                              undsel[
                                                                                  ...
                                                                                  <Grid
                                                                                      ...
                                                                                      <div className="textopreciounitcompracuatro">
                                                                                          Precio
                                                                                          Unitario:
                                                                                          $
                                                                                          {myNumber(
                                                                                  ...
                                                                                  <Grid
                                                                                      ...
                                                                                      <div className="textopreciototcompracuatro">
                                                                                          Precio
                                                                                          Total
                                                                                          :
                                                                                          $
                                                                  ...
                                                                  index + 1 ? (
                                                                      <div className="ancholineashippingall">
                                                                          <hr />
                                                                      </div>
                                                                  ) : null}
                                                              </div>
                                    ...
                                    <Grid
                                        ...
                                        lg={12}
                                        onClick={() => metodosPago()}>
                                        <div className="botoncontinuarenvioall">
                                            Siguiente
                                        </div>
                                    </Grid>
                                </Grid>
...
export default ShippingInformationAll;
