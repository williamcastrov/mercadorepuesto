                                        ...
                                        <Grid item xs={12} md={12} lg={12}>
                                            <a>
                                                ...
                                                <p className="textosugerencia">
                                                    - El número de la cédula debe tener como mínimo seis carácteres
                                                </p>
                                                <p className="textosugerencia">
                                                    - No debe incluir caracteres alfanuméricos
                                                </p>
                                                <p className="textosugerencia">
                                                    - El número de teléfono debe tener como mínimo 10 carácteres
                                                </p>
                                                <p className="textosugerencia">
                                                    - Debes incluir un email valido
                                                </p>
                                            </a>
                                        </Grid>
