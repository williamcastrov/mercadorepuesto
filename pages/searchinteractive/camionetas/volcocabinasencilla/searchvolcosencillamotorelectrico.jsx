                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajaimagenesmotorelectricovolcosencilla pt-19">
                                        <h2 className="mt-39 seccionesvehiculotexto"></h2>
                                        <img src={imagenBase.src} />
                                    </div>
                                </Col>
                            </Row>
                        ) : showSistmotor ? (
                            <div className="cajaimagenesmotorelectricovolcosencilla">
                            ...
                            <div className="cajaimagenesmotorelectricovolcosencilla espaciosuperior">
                        ...
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"10"} />
                        </div>
                    ) : onClickEscape ? (
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"11"} />
                        </div>
                    ) : onClickAirecondicionado ? (
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            <h2 className="seccionesvehiculotexto">
                        ...
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"13"} />
                        </div>
                    ) : onClickSistdeArranque ? (
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"14"} />
                        </div>
                    ) : onClickSistdeParabrisas ? (
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"15"} />
                        </div>
                    ) : onClickElectricoMotor ? (
                        <div className="cajaimagenesmotorelectricovolcosencilla">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <VolcoSencillaMotorElectrico motorelectrico={"16"} />
                        </div>
                    ) : null}
                </Col>
            </div>
