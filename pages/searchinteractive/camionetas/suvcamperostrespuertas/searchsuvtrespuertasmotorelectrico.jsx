                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajaimagenesmotorelectricosuvtrespuertas pt-29">
                                        <h2 className="mt-61 seccionesvehiculotexto"></h2>
                                        <img src={imagenBase.src} />
                                    </div>
                                </Col>
                            </Row>
                        ) : showSistmotor ? (
                            <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            ...
                            <div className="cajaimagenesmotorelectricosuvtrespuertas espaciosuperior">
                        ...
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"1"} />
                        </div>
                    ) : onClickTransmision ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"2"} />
                        </div>
                    ) : onClickFrenos ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"3"} />
                        </div>
                    ) : onClickDireccion ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"4"} />
                        </div>
                    ) : onClickSuspension ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"5"} />
                        </div>
                    ) : onClickCaja ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"6"} />
                        </div>
                    ) : onClickEmbrague ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"7"} />
                        </div>
                    ) : onClickInyeccion ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"8"} />
                        </div>
                    ) : onClickRefrigeracion ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"9"} />
                        </div>
                    ) : onClickRefrigeracionCaja ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"10"} />
                        </div>
                    ) : onClickEscape ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"11"} />
                        </div>
                    ) : onClickAirecondicionado ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                        ...
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"13"} />
                        </div>
                    ) : onClickSistdeArranque ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"14"} />
                        </div>
                    ) : onClickSistdeParabrisas ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"15"} />
                        </div>
                    ) : onClickElectricoMotor ? (
                        <div className="cajaimagenesmotorelectricosuvtrespuertas">
                            <h2 className="seccionesvehiculotexto">
                            ...
                            <SUVTresPuertasMotorElectrico motorelectrico={"16"} />
                        </div>
                    ) : null}
                </Col>
            </div>
