                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoBuses
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoBuses
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoBuses()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaBuses
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaBuses
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorBuses()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasBuses
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasBuses
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasBuses()
                                                                    }
