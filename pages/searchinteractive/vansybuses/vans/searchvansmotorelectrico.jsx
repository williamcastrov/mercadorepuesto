...
const SearchInteractiveMotorElectrico = (props) => {
    ...
    const mostrarAireAcondicionadoVans = () => {
    ...
    const cerrarAireAcondicionadoVans = () => {
        setShowAirecondicionado(false);
        setShowImagenMtrElect(true);
    };

    const mostrarDireccionVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarDireccionVans = () => {
        setShowDireccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarFrenosVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowFrenos(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarFrenosVans = () => {
        setShowFrenos(false);
        setShowImagenMtrElect(true);
    };

    const mostrarMotorcajaVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
            setShowCaja(true);
            setOnClickImagenMtrElect(false);
    ...
    const cerrarMotorcajaVans = () => {
        setShowCaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarRefrigeracioncajaVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarRefrigeracioncajaVans = () => {
        setShowRefrigeracioncaja(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdearranqueVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdearranqueVans = () => {
        setShowImagenMtrElect(true);
        setShowSistdearranque(false);
    };

    const mostrarSistparabrisasVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistparabrisasVans = () => {
        setShowImagenMtrElect(true);
        setShowSistparabrisas(false);
    };

    const mostrarSistmotorVans = () => {
        if (!onClickImagenMtrElect) {
    ...
    const cerrarSistmotorVans = () => {
        setShowSistmotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEmbragueVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEmbragueVans = () => {
        setShowSistdeEmbrague(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeEscapeVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeEscapeVans = () => {
        setShowSistdeEscape(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeInyeccionVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeInyeccionVans = () => {
        setShowSistdeInyeccion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeRefrigeracionVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeRefrigeracionVans = () => {
        setShowSistdeRefrigeracion(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoVans = () => {
        setShowSistdeElectrico(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistdeElectricoMotorVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistdeElectricoMotorVans = () => {
        setShowSistdeElectricoMotor(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSuspensionVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSuspensionVans = () => {
        setShowSuspension(false);
        setShowImagenMtrElect(true);
    };

    const mostrarSistTrasmisionVans = () => {
        if (!onClickImagenMtrElect) {
            setShowImagenMtrElect(false);
    ...
    const cerrarSistTrasmisionVans = () => {
        setShowSistTrasmision(false);
        setShowImagenMtrElect(true);
    };

    const prdAireacondicionadoVans = () => {
    ...
    const prdElectricoVehiculoVans = () => {
        setDatosFaltantes(false);
        localStorage.setItem(
            "ubicacionproducto",
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    ...
                                                                    onMouseOver={
                                                                        mostrarSistdeInyeccionVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeInyeccionVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdInyeccionVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeRefrigeracionVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeRefrigeracionVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdRefrijeracionVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoMotorVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoMotorVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoMotorVans()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdearranqueVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdearranqueVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdArranqueVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEscapeVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEscapeVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdEscapeVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarAireAcondicionadoVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarAireAcondicionadoVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdAireacondicionadoVans()
                                                                    }
                                                                    src={
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeEmbragueVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeEmbragueVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdEmbragueVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico deshabilitardiv">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarRefrigeracioncajaVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarRefrigeracioncajaVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdEnframientoMotorVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistTrasmisionVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistTrasmisionVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdTrasmisionVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSuspensionVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSuspensionVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdSuspensionVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistparabrisasVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistparabrisasVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdParabrisasVans()
                                                                    }
                                                        ...
                                                        <Col xs lg={12}>
                                                            <div className="bordediviconomotorelectrico">
                                                                <img
                                                                    className="tamañoimagensedamotorelectrico"
                                                                    onMouseOver={
                                                                        mostrarSistdeElectricoVans
                                                                    }
                                                                    onMouseOut={
                                                                        cerrarSistdeElectricoVans
                                                                    }
                                                                    onClick={() =>
                                                                        prdElectricoVehiculoVans()
                                                                    }
                                                                    src={
                ...
                <Col xs lg={10}>
                    {!onClickImagenMtrElect ? (
                        showImagenMtrElect ? (
                            <Row>
                                <Col xs lg={12}>
                                    <div className="cajasedanimagenesmotorelectricovans pt-29">
                            ...
                            <div className="cajasedanimagenesmotorelectricovans">
                            ...
                            <div className="cajasedanimagenesmotorelectricovans espaciosuperior">
