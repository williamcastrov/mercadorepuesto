...
function DatosVehiculosCuatro(props) {
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        /*
        if (
            !localStorage.getItem("datosmodelosvehiculosCuatro") ||
            localStorage.getItem("datosmodelosvehiculosCuatro") === undefined
        ) {
            if (modelos.length > 0) {
                localStorage.setItem(
                    "datosmodelosvehiculosCuatro",
...
*/
    ...
    const handleChangeTraccion = (selectedOptions) => {
        ...
        setTipoVehCuatro(tipoVeh[0]);
        setMarcaVehCuatro(marcaVeh);
        setAnnoVehCuatro(annoVeh);
        setModeloVehCuatro(modeloVeh[0]);
            ...
            {vehiculoCuatroCrear ? (
                ...
                <div>
                    <Row>
                        ...
                        <Col xl={1} lg={1} md={1} xs={1}>
                            <div className="form-control ps-form__input ml-95 textoeditardatosvehiculo">
                                <i
