...
function DatosVehiculosCuatro(props) {
    ...
    useEffect(() => {
        ...
        // Lee modelos de los Vehiculos del state
        const datosDuplicar = JSON.parse(
            localStorage.getItem("duplicarvehiculo")
        );
    ...
    const handleChangeCombustible = (selectedOptions) => {
        ...
        if (tipoVehUno == 1 || tipoVehUno == 3 || tipoVehUno == 6) {
            ...
            setcombustibleVehCuatro(selectedOptions);
            ...
            {vehiculoCuatroCrear ? (
                ...
                <div>
                    <Row>
                        ...
                        <Col xl={1} lg={1} md={1} xs={1}>
                            <div className="form-control ps-form__input ml-95 textoeditardatosvehiculo botonazul textocolorblanco">
                                <i
