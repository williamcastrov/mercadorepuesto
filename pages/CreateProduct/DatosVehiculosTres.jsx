...
function DatosVehiculosTres(props) {
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        /*
        if (
            !localStorage.getItem("datosmodelosvehiculosTres") ||
            localStorage.getItem("datosmodelosvehiculosTres") === undefined
        ) {
            if (modelos.length > 0) {
                localStorage.setItem(
                    "datosmodelosvehiculosTres",
...
*/
    ...
    const handleChangeTraccion = (selectedOptions) => {
        ...
        setTipoVehTres(tipoVeh[0]);
        setMarcaVehTres(marcaVeh);
        setAnnoVehTres(annoVeh);
        setModeloVehTres(modeloVeh[0]);
