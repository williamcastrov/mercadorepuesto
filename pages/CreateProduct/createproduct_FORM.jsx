                                    ...
                                    <div className="ps-form--review">
                                        ...
                                        {showCreateProduct ? (
                                            <div className="cajavehiculoscompatiblesproducto">
                                                <div className="cajavehiculoscompatiblesproductosuperiodo">
                                                    <h4 className="titulopasarela"> 
                                                        Vehículos compatibles con tu producto
                                                    </h4>
                                                </div>
                                                <div className="ps-form__group mt-20 ml-20">
                                                    <Row>
                                                        <Col
                                                            xl={11}
                                                            lg={11}
