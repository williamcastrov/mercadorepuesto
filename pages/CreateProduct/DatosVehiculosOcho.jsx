...
function DatosVehiculosOcho(props) {
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        /*
        if (
            !localStorage.getItem("datosmodelosvehiculosOcho") ||
            localStorage.getItem("datosmodelosvehiculosOcho") === undefined
        ) {
            if (modelos.length > 0) {
                localStorage.setItem(
                    "datosmodelosvehiculosOcho",
...
*/
    ...
    const handleChangeTraccion = (selectedOptions) => {
        ...
        setTipoVehOcho(tipoVeh[0]);
        setMarcaVehOcho(marcaVeh);
        setAnnoVehOcho(annoVeh);
        setModeloVehOcho(modeloVeh[0]);
