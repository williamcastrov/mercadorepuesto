...
function DatosVehiculosCinco(props) {
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        /*
        if (
            !localStorage.getItem("datosmodelosvehiculosCinco") ||
            localStorage.getItem("datosmodelosvehiculosCinco") === undefined
        ) {
            if (modelos.length > 0) {
                localStorage.setItem(
                    "datosmodelosvehiculosCinco",
...
*/
    ...
    const handleChangeTraccion = (selectedOptions) => {
        ...
        setTipoVehCinco(tipoVeh[0]);
        setMarcaVehCinco(marcaVeh);
        setAnnoVehCinco(annoVeh);
        setModeloVehCinco(modeloVeh[0]);
