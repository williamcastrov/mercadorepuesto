...
function RegistrarFotos(props) {
    ...
    let duplicarprd = useSelector((state) => state.duplicarprd.duplicarprd);
            ...
            const leeVehiculosTemporal = async () => {
                ...
                await axios({
                    ...
                    .then((res) => {
                        ...
                        console.log("DAT VEH COMP: ", res.data);
                    })
    ...
    const grabarfoto = async (dato, ext) => {
        ...
        switch (longitud) {
            case 1:
                datoimagen = {
                    longitud,
                    nombreimagen1: nombrefoto + "-0" + ext,
                    imagen1: dato[0],
                };
                break;
            case 2:
                datoimagen = {
                    ...
                    nombreimagen1: nombrefoto + "-0" + ext,
                    imagen1: dato[0],
                    nombreimagen2: nombrefoto + "-1" + ext,
                    imagen2: dato[1],
                };
                break;
            case 3:
                datoimagen = {
                    ...
                    nombreimagen2: nombrefoto + "-1" + ext,
                    imagen2: dato[1],
                    nombreimagen3: nombrefoto + "-2" + ext,
                    imagen3: dato[2],
                };
                break;
            case 4:
                datoimagen = {
                    ...
                    nombreimagen3: nombrefoto + "-2" + ext,
                    imagen3: dato[2],
                    nombreimagen4: nombrefoto + "-3" + ext,
                    imagen4: dato[3],
                };
                break;
            case 5:
                datoimagen = {
                    ...
                    nombreimagen4: nombrefoto + "-3" + ext,
                    imagen4: dato[3],
                    nombreimagen5: nombrefoto + "-4" + ext,
                    imagen5: dato[4],
                };
                break;
            case 6:
                datoimagen = {
                    ...
                    nombreimagen5: nombrefoto + "-4" + ext,
                    imagen5: dato[4],
                    nombreimagen6: nombrefoto + "-5" + ext,
                    imagen6: dato[5],
                };
                break;
            case 7:
                datoimagen = {
                    ...
                    nombreimagen6: nombrefoto + "-5" + ext,
                    imagen6: dato[5],
                    nombreimagen7: nombrefoto + "-6" + ext,
                    imagen7: dato[6],
                };
                break;
            case 8:
                datoimagen = {
                    ...
                    nombreimagen7: nombrefoto + "-6" + ext,
                    imagen7: dato[6],
                    nombreimagen8: nombrefoto + "-7" + ext,
                    imagen8: dato[7],
                };
                break;
            case 9:
                datoimagen = {
                    ...
                    nombreimagen8: nombrefoto + "-7" + ext,
                    imagen8: dato[7],
                    nombreimagen9: nombrefoto + "-8" + ext,
                    imagen9: dato[8],
                };
                break;
            case 10:
                datoimagen = {
                    ...
                    nombreimagen9: nombrefoto + "-8" + ext,
                    imagen9: dato[8],
                    nombreimagen10: nombrefoto + "-9" + ext,
                    imagen10: dato[10],
                };
                break;
            default:
    ...
    const creaProducto = async (datosimagenes) => {
        ...
        if (duplicarprd == 1 || duplicarprd == 2) {
            ...
            valorproducto = datpubli[0].precio;
        } else {
        ...
        //alert(imagenesLoad[0].substr(46, 40))
        //return

        //console.log("DATOS IMG : ", datosimagenes)
        if (duplicarprd == 1 || duplicarprd == 2) {
            if (numImg >= 1) {
    ...
    const onSelectFileAnt = (event) => {
        ...
        if (imagenesLoad.length > 0 && long > 0) {
            let posicion = contadorimg;
            let array = imagenesLoad;
        }

        //console.log("NVO ARRAU : ", arrayload);
            ...
            if (file.size > 1050000) {
                ...
                if ((archivo = file)) {
                    ...
                    img.onload = function () {
                        ...
                        console.log("ALTO UNO: ", proaltominimo);
    ...
    const onSelectFile = (
        ...
        if (duplicarprd == 1 || duplicarprd == 2) {
            ...
            console.log("CONTADOR DDDDDD : ", tres.length);
        }
    };
            ...
            {isLoading ? (
                ...
                <form onChange={onChange} className="ml-25">
                    <div className="ps-form--review">
                        {console.log("IMAGES LOAD : ", imagenesLoad)}
                        <Form.Group
