...
function DatosVehiculosSeis(props) {
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        /*
        if (
            !localStorage.getItem("datosmodelosvehiculosSeis") ||
            localStorage.getItem("datosmodelosvehiculosSeis") === undefined
        ) {
            if (modelos.length > 0) {
                localStorage.setItem(
                    "datosmodelosvehiculosSeis",
...
*/
    ...
    const handleChangeTraccion = (selectedOptions) => {
        ...
        setTipoVehSeis(tipoVeh[0]);
        setMarcaVehSeis(marcaVeh);
        setAnnoVehSeis(annoVeh);
        setModeloVehSeis(modeloVeh[0]);
