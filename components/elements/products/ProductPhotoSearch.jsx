...
import ModuleProductImagesSearch from "~/components/elements/products/modules/ModuleProductImagesSearch";

const ProductPhotoSearch = ({ product }) => {
    ...
    return (
        <div className="ps-product ps-product--grid">
            <div className="ps-product__thumbnail">
                ...
                <ModuleProductImagesSearch product={product} />
...
export default ProductPhotoSearch;
